...
fn main() -> eframe::Result {
    ...
    eframe::run_native(
        "ahmet kayaify",
        native_options,
        Box::new(|cc| Ok(Box::new(ahmetkayaify::AhmetKayaifyApp::new(cc)))),
    )
}
...
fn start_app() {
    ...
    //web_sys::console::log_1(&"Starting ahmet kayaify...".into());
...
pub fn main() {
    ...
    if web_sys::js_sys::global()
        ...
        .is_some()
    {
        ahmetkayaify::worker_entry(); // <- your existing function that sets onmessage, etc.
        return;
    }
